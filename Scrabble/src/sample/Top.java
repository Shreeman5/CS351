...
public class Top {
    ...
    /**
     * check the top places of a playable square
     * @param i
     * @param word
     * @param board
     * @param parent
     ...
     * @param letters
     */
    public void checkTop(int i, String word, String[][] board, TrieNode parent,
                         ArrayList<Point> viableCoord, Score score, Letters letters){
        //System.out.println("Word: "+word);
        //System.out.println("princk");
        ...
        int playableSquaresTop = viableCoord.get(i).x + 1;
        //System.out.println();
        //System.out.println("PlayableSquaresTop: "+playableSquaresTop);
        int temp = x;
        //System.out.println("temp: "+temp);

        if(word.length() > playableSquaresTop){
            //do nothing;
        }
        else{
            ...
            if(x > 0) {
                if (!board[x - 1][y].equals("..") && !board[x - 1][y].equals("3.") &&
                        !board[x - 1][y].equals("2.")
                        && !board[x - 1][y].equals(".2") && !board[x - 1][y].equals(".3") &&
            ...
            if (counter >= word.length()) {
                ...
                //System.out.println("BBA: " + bb);
                //System.out.println("ZZA: " + zz);
                topToBottom.add(new Point(bb, zz));
                //System.out.println("Counter: " + counter);
                bb = temp;
                zz = y;
                int k = word.length() - 1;
                ...
                if (bb < 0) {
                    ...
                    while (bb > 0 && !board[bb - 1][zz].equals("..") &&
                            ...
                            && !board[bb - 1][zz].equals("4.")) {
                        check = board[bb - 1][zz] + check;
                        bb--;
                    }
                }
                //System.out.println("BBBBBBB: " + bb);
                //System.out.println("ZZZZZZZ: " + zz);
                topToBottom.add(0, new Point(bb, zz));
            ...
            if(validWord == true){
                //System.out.println("" +word+ " can be played on the board from the start to the end of this list: "+topToBottom);
                if(word.contains("*")){
                    for(int w = 0; w < alphabets.length; w++){
                        if(alphabets[w] == true){
